    ...
    def test_get_config(self, simple_types: bool) -> None:
        ...
        expected = {
            ...
            "transformer_layers_type": (
                "rectools.models.nn.sasrec.SASRecTransformerLayers" if simple_types else SASRecTransformerLayers
            ),
            "data_preparator_type": (
                "rectools.models.nn.sasrec.SASRecDataPreparator" if simple_types else SASRecDataPreparator
            ),

...
from rectools.metrics.ranking import MAP, MRR, NDCG, pAUC
...
class TestpAUC:
    ...
    def test_calc(self, k: int, insufficient_cases: str, expected_pauc: tp.List[float], expected_users: tp.List[int]) -> None:
        reco = pd.DataFrame(
            {
                Columns.User: [1, 2, 3, 3, 3, 4, 5, 5, 5, 5],
                Columns.Item: [1, 2, 1, 2, 3, 1, 1, 2, 3, 5],
    ...
    def test_when_duplicates_in_interactions_insufficient(self, k: int, insufficient_cases: str, expected_pauc: tp.List[int], expected_users: tp.List[int]) -> None:
        reco = pd.DataFrame(
            {
                Columns.User: [1, 1, 1, 2, 2, 2],
                Columns.Item: [1, 2, 3, 1, 2, 3],
...
# TODO: consirder if duplicate test is correct (also for "raise")
# TODO: test raise
# TODO: exclude -> nan?
